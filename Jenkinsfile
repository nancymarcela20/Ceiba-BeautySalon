pipeline {
    ...
    stage('Checkout'){
    	steps{
            ...
            checkout([
                ...
                submoduleCfg: [],
                userRemoteConfigs: [[
                    credentialsId: 'GitHub_nancyalvarez',
                    url:'https://github.com/nancyalvarez/ceiba-beauty-salon.git'
                ]]
            ])
  ...
  post {
    ...
    failure {
      ...
      mail (to: 'nancy.alvarez@ceiba.com.co',subject: "Failed Pipeline:${currentBuild.fullDisplayName}", body: "Something is wrong with ${env.BUILD_URL}")
    }
    unstable {
